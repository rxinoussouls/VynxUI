...
local function __vynx_require(key)
    ...
    if not fn then error('[VynxUI] module not found: '..tostring(key), 2) end
    local r = fn()
    __vynx_cache[key] = r ~= nil and r or true
...
__vynx_fns["components/ui/ScrollSlider.lua"] = function()
local ScrollSlider = {}
...
__vynx_fns["components/search/Icons.lua"] = function()
return { -- lucide
...
__vynx_fns["components/search/Init.lua"] = function()
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
function SearchBar.new(TabModule, Parent, OnClose)
	local SearchBarModule = {
		...
		Icons = __vynx_require("components/search/Icons.lua"),
	}
...
__vynx_fns["components/ui/Label.lua"] = function()
local Label = {}
...
__vynx_fns["components/window/KeyBindMenu.lua"] = function()
...
__vynx_fns["components/window/SettingsMenu.lua"] = function()
local UserInputService = game:GetService("UserInputService")
local Workspace = game:GetService("Workspace")
...
__vynx_fns["components/ui/Tag.lua"] = function()
local Tag = {}
...
__vynx_fns["components/window/Openbutton.lua"] = function()
local OpenButton = {}
...
__vynx_fns["components/window/Watermark.lua"] = function()
local Watermark = {}
...
__vynx_fns["components/window/GoldenEffect.lua"] = function()
local TweenService = game:GetService("TweenService")
...
__vynx_fns["components/window/Element.lua"] = function()
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Creator = __vynx_require("modules/Creator.lua")
local Motion = __vynx_require("modules/Motion.lua")
local New = Creator.New
local NewRoundFrame = Creator.NewRoundFrame
local GoldenEffect = __vynx_require("components/window/GoldenEffect.lua")
...
__vynx_fns["components/ui/Checkbox.lua"] = function()
local Checkbox = {}
...
__vynx_fns["components/ui/Toggle.lua"] = function()
local Toggle = {}
...
__vynx_fns["components/ui/Dropdown.lua"] = function()
local DropdownMenu = {}
	...
	function DropdownModule:Refresh(Values)
		...
		for Index, Tab in next, Values do
			if typeof(Tab) ~= "table" or Tab.Type ~= "Divider" then
				...
				__vynx_require("elements/Divider.lua"):New({ Parent = Dropdown.UIElements.Menu.Frame.ScrollingFrame })
			end
		end
...
__vynx_fns["components/ui/Input.lua"] = function()
local Input = {}
...
__vynx_fns["components/ui/Button.lua"] = function()
local Button = {}
...
__vynx_fns["components/ui/Code.lua"] = function()
local Code = {}
...
local Highlighter = __vynx_require("modules/Highlighter.lua")
...
__vynx_fns["components/window/Dialog.lua"] = function()
local Creator = __vynx_require("modules/Creator.lua")
local New = Creator.New
local Tween = Creator.Tween
...
__vynx_fns["components/ui/Tooltip.lua"] = function()
local Tooltip = {}
...
__vynx_fns["components/window/Tab.lua"] = function()
local cloneref = (cloneref or clonereference or function(instance)
	return instance
end)
...
__vynx_fns["components/window/Section.lua"] = function()
local Section = {}
...
local TabModule = __vynx_require("components/window/Tab.lua")
...
__vynx_fns["config/Init.lua"] = function()
local cloneref = (cloneref or clonereference or function(instance) return instance end)
...
__vynx_fns["components/window/Init.lua"] = function()
...
local ConfigManager = __vynx_require("config/Init.lua")
...
return function(Config)
	...
	Window.OpenButtonMain = __vynx_require("components/window/Openbutton.lua").New(Window)
	Window.OpenButtonController = Window.OpenButtonMain
	Window.WatermarkMain = __vynx_require("components/window/Watermark.lua").New(Window, Config.WindUI)
	...
	if Window.Settings ~= false and Window.Topbar.Settings ~= false then
		local SettingsMenu = __vynx_require("components/window/SettingsMenu.lua").New(Window, Config.WindUI, Config)
	...
	if Window.KeyBindMenu ~= false and Window.Topbar.KeyBindMenu ~= false then
		local KeyBindMenu = __vynx_require("components/window/KeyBindMenu.lua").New(Window, Config.WindUI, Config)
	...
	local TabModuleMain = __vynx_require("components/window/Tab.lua")
	local SectionModule = __vynx_require("components/window/Section.lua")
	...
	local DialogModule = __vynx_require("components/window/Dialog.lua")
	...
	if not Window.HideSearchBar then
		local SearchBar = __vynx_require("components/search/Init.lua")
		local IsOpen = false
...
__vynx_fns["components/popup/Init.lua"] = function()
local PopupModule = {}
...
function PopupModule.new(PopupConfig, Parent)
    ...
    local DialogInit = __vynx_require("components/window/Dialog.lua")
...
function VynxUI:CreateWindow(Config)
	local CreateWindowModule = __vynx_require("components/window/Init.lua")
...
function KeySystem.new(Config, Filename, func, keyValidator)
	local KeyDialogInit = __vynx_require("components/window/Dialog.lua")
...
__vynx_fns["components/popup/Element.lua"] = function()
local Element = {}
...
return __vynx_require("Init.lua")