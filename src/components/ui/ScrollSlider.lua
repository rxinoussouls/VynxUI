...
function ScrollSlider.New(ScrollingFrame, Parent, Window, Thickness, VynxUI)
	...
	local function StopDrag()
		if VynxUI.CurrentInput == ScrollSliderActionId then
	...
	Creator.AddSignal(Hitbox.InputBegan, function(input)
		...
		if VynxUI.CurrentInput and VynxUI.CurrentInput ~= ScrollSliderActionId then
			return
		end

		VynxUI.CurrentInput = ScrollSliderActionId
